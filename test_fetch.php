...
// Test 5: Check recent messages untuk user yang login
...
// Test 6: Simulate fetch dengan current user
if (isset($_SESSION['user_id'])) {
    echo "=== SIMULATE FETCH ===\n";
    $current_user = (int) $_SESSION['user_id'];
    
    try {
        // Cari user lain untuk testing
        ...
        if ($other_users) {
            foreach ($other_users as $other) {
                ...
                // Gunakan positional parameters seperti di fetch_message.php
...
// Test 7: Interactive API testing
