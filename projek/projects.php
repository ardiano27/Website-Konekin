...
<head>
    ...
    <style>
        ...
        .stat-card.completed .stat-icon { background: var(--success-light); color: var(--success-color); }
                        ...
                        <div class="col-lg-4 text-lg-end d-none d-lg-block">
                            <div class="position-relative" style="max-width: 300px; margin-left: auto;">
                                ...
                                <div class="position-relative p-4 rounded-3">
                                    <h5 class="mb-2">🚀 Proyek Aktif</h5>
                                    <h2 class="mb-0"><?php echo $stats['in_progress']; ?></h2>
                                    <small class="opacity-75">dari <?php echo $stats['total']; ?> total proyek</small>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="stats-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card new">
                        ...
                        <div class="stat-number"><?php echo $stats['new_proposals']; ?></div>
                        <div class="stat-label">Proposal Baru</div>
                        <div class="stat-trend">
                            <i class="fas fa-clock"></i>
                            <?php echo $stats['total_proposals']; ?> Total
                        </div>
                    </div>
                    ...
                    <?php if (count($projects) > 0): ?>
                        <?php foreach ($projects as $index => $project): ?>
                            ...
                            if ($project['status'] === 'in_progress') {
                                $progress = $project['contract_count'] > 0 ? rand(30, 90) : 0;
                            ...
                            <div class="project-card project-item" 
                                ...
                                <div class="project-card-body">
                                    ...
                                    <?php if ($project['status'] === 'in_progress' && $progress > 0): ?>
                                ...
                                <div class="project-card-footer">
                                    <div class="action-buttons">
                                        ...
                                        <?php elseif ($project['status'] === 'in_progress'): ?>
                                            ...
                                            <a href="milestones.php?project_id=<?php echo $project['id']; ?>" class="action-btn warning">
                                                <i class="fas fa-flag me-1"></i>Milestone
                                            </a>
                                        <?php elseif ($project['status'] === 'completed'): ?>
                                            <a href="project-review.php?id=<?php echo $project['id']; ?>" class="action-btn success">
                                                <i class="fas fa-star me-1"></i>Review
                                            </a>
                                            <a href="project-details.php?id=<?php echo $project['id']; ?>" class="action-btn primary">
